        ...
        methods: {
            ...
            createOneMarker (data) {
                if (data) {
                    ...
                    // let { latitude, longtitude, operatorName, arrivetime, msisdn, name,
                    //     staytime, homeCodeName, addressName, lastUpdateTime, flag } = data
                    if (this.zdr === name && this.pointMarker.point) {
                        ...
                        if (latitude && longtitude) {
                            ...
                            let personPoint = [
                                { name: '姓名：', value: name },
                                { name: '电话：', value: msisdn },
                                { name: '标签：', value: flag },
                                { name: '到达时间：', value: arrivetime },
                                { name: '最新位置：', value: addressName }
                            ]
