/**
 * @fileoverview �ٶȵ�ͼ������ͼ����,���⿪�š�
 * ��Ҫ����http://www.patrick-wied.at/static/heatmapjs/index.html �޸Ķ���


/*==============================���²���Ϊheatmap.js�ĺ��Ĵ���,ֻ��������ͼ��չ��, �������Ե�����====================================*/
 ...
 * ���������<a href="symbols/BMapLib.Heatmap.html">Heatmap</a>��
 * ����Baidu Map API 2.0��
 *
...
(function() {
     ...
     * ����ͼ�ĸ�����
     * @class ����ͼ�ĸ�����
     * ʵ���������ʹ��map.addOverlay�������������ͼ
     * 
     * @constructor
     * @param {Json Object} opts ��ѡ������������Ǳ����������ѡ�������<br />
     * {"<b>radius</b>" : {String} ����ͼ�İ뾶,
     * <br />"<b>visible</b>" : {Number} ����ͼ�Ƿ���ʾ,
     * <br />"<b>gradient</b>" : {JSON} ����ͼ�Ľ�������,
     * <br />"<b>opacity</b>" : {Number} ������͸����,
     *
     * @example <b>�ο�ʾ����</b><br />
     * var map = new BMap.Map("container");<br />map.centerAndZoom(new BMap.Point(116.404, 39.915), 15);<br />var heatmapOverlay = new BMapLib.HeatmapOverlay({"radius":10, "visible":true, "opacity":70});<br />heatmapOverlay.setDataSet(data);//data������ͼ����ϸ����
     */
     ...
     * {"<b>max</b>" : {Number} Ȩ�ص����ֵ,
     * <br />"<b>data</b>" : {Array} ������ϸ����,��ʽ���� <br/>
     * {"lng":116.421969,"lat":39.913527,"count":3}, ����<br/>
     * lng lat�ֱ�Ϊ��γ��, countȨ��ֵ
     */
    ...
    BMapLib.HeatmapOverlay = HeatmapOverlay; // �������ռ�ע��.
})()